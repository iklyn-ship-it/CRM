...
alter table if exists public.orders
  ...
  add column if not exists logistics_return_provider text not null default 'own_trawl',
  add column if not exists logistics_return_trailer_id text not null default '',
  add column if not exists logistics_return_start_date text not null default '',
  add column if not exists logistics_return_end_date text not null default '',
